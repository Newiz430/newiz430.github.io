...
#### [A Survey on Self-Supervised Graph Foundation Models: Knowledge-Based Perspective](https://arxiv.org/abs/2403.16137) (TKDE'25) ![Static Badge](https://img.shields.io/badge/CCF--A-blue) ![Static Badge](https://img.shields.io/badge/survey-yellow)
**Ziwen Zhao\***, Yixin Su\*, Yuhua Li, Yixiong Zou, Ruixuan Li, Rui Zhang  [[Paper list]](https://github.com/Newiz430/Pretext)

We present a new graph knowledge-based taxonomy (9 types, 300 refs, 500+ papers) to categorize self-supervised GFMs, incl. GNNs, Graph Transformers, graph language models (GLMs), and more.

#### [Masked Graph Autoencoder with Non-discrete Bandwidths](https://arxiv.org/abs/2402.03814) (WWW/TheWebConf'24) ![Static Badge](https://img.shields.io/badge/CCF--A-blue)
...
#### [CSGCL: Community-Strength-Enhanced Graph Contrastive Learning](https://arxiv.org/abs/2305.04658) (IJCAI'23) ![Static Badge](https://img.shields.io/badge/CCF--A-blue)
